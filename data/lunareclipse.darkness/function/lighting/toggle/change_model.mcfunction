...
$execute if score @s darkness.$(item)_enabled matches 1 if items entity @s armor.head minecraft:wooden_pickaxe[minecraft:custom_data={$(item):1b}] run return run item modify entity @s armor.head { "function": "minecraft:set_components", "components": { "minecraft:item_model": "lunareclipse.darkness:$(item)/unlit" } }
$execute unless score @s darkness.$(item)_enabled matches 1 if items entity @s armor.head minecraft:wooden_pickaxe[minecraft:custom_data={$(item):1b}] run return run item modify entity @s armor.head { "function": "minecraft:set_components", "components": { "minecraft:item_model": "lunareclipse.darkness:$(item)/lit" } }
